...
static inline float gaussian_2d(int x, int y, float sig);
static inline int border(std::vector<feature> &features, int w, int min_block_width, bool axis_x);
static inline void region_iponts(std::vector<feature> &features, struct region &reg);
static void segment(int w, int h, std::vector<struct feature> &features, std::vector<struct region> &regs);
static void estimate(int w, int h, std::vector<struct feature> &features, 
...
static void segment(int w, int h, std::vector<struct feature> &features,
    std::vector<struct region> &regs) {
